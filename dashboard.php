...
<div class="page">
  ...
  <!-- QUICK ACCESS -->
  <div class="card">
    <div class="card-header"><div class="card-title"><img src="https://api.iconify.design/ph/lightning-bold.svg" style="width:18px;height:18px;vertical-align:middle;filter:invert(1)"> Truy cập nhanh</div></div>
    <div class="card-body">
      <div class="quick-grid">
        <a href="chat.php"      class="quick-btn"><span class="quick-btn-icon"><img src="https://api.iconify.design/ph/brain-bold.svg" style="width:18px;height:18px;vertical-align:middle;filter:invert(1)"></span>Chat AI</a>
        <a href="flashcard.php" class="quick-btn"><span class="quick-btn-icon"><img src="https://api.iconify.design/ph/lightning-bold.svg" style="width:18px;height:18px;vertical-align:middle;filter:invert(1)"></span>Flashcard</a>
        <a href="notes.php"     class="quick-btn"><span class="quick-btn-icon"><img src="https://api.iconify.design/ph/note-bold.svg" style="width:24px;height:24px"></span>Ghi chú</a>
        <a href="planner.php"   class="quick-btn"><span class="quick-btn-icon"><img src="https://api.iconify.design/ph/calendar-bold.svg" style="width:24px;height:24px"></span>Kế hoạch</a>
        <a href="pomodoro.php"  class="quick-btn"><span class="quick-btn-icon"><img src="https://api.iconify.design/ph/timer-bold.svg" style="width:18px;height:18px;vertical-align:middle;filter:invert(1)"></span>Pomodoro</a>
        <a href="mindmap.php"   class="quick-btn"><span class="quick-btn-icon"><img src="https://api.iconify.design/ph/map-trifold-bold.svg" style="width:18px;height:18px;vertical-align:middle;filter:invert(1)"></span>Mind Map</a>
        <a href="math.php"      class="quick-btn"><span class="quick-btn-icon"><img src="https://api.iconify.design/ph/calculator-bold.svg" style="width:18px;height:18px;vertical-align:middle;filter:invert(1)"></span>Toán</a>
        <a href="quiz.php"      class="quick-btn"><span class="quick-btn-icon"><img src="https://api.iconify.design/ph/target-bold.svg" style="width:18px;height:18px;vertical-align:middle;filter:invert(1)"></span>Quiz</a>
      </div>
    </div>
  </div>
